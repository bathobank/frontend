  ...
  return (
    <div className="game-box rounded-3">
      <div className="d-flex align-items-center p-3 game-header">
        ...
        <h5 className="mb-0 ms-2 text-white">CHẴN LẺ - TÀI XỈU - CỘNG 2 SỐ</h5>
      </div>
      <div className="p-3">
            ...
            {Object.keys(gameData).map((key, index) => {
              ...
              return (
                ...
                >
                  ...
                  <td className="py-3">
                    <HightLightEnd ends={game.sum2end} />
                  </td>
        ...
        <div className="py-5">
          <p className="italic fs-md text-center">
            KẾT QUẢ TÍNH BẰNG <span className="hl-text">TỔNG 2 SỐ CUỐI</span>{" "}
