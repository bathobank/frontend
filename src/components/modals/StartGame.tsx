...
export const StartGameModal = ({
  ...
  const [formData, setFormData] = useState<TForm>({bank: undefined, money: 0});
      ...
      <Box className="p-5">
        <Box>
          ...
          <Box className="text-center">
            <Button variant="theme" className="w-[60%] min-w-[200px]" onClick={generateQrGame} disabled={disableButtonGenQr}>Tạo mã QR</Button>
          </Box>
        </Box>
